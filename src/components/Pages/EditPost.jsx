                    ...
                    <ModalBody>
                        ...
                        <form onSubmit={handelSubmit} >
                            ...
                            <div className=' p-1 col'>
                                ...
                                <input type="file" onChange={(e) => { setMyfile(e.target.files[0]) }} style={{ width: "100%", boxShadow: ` 3px 3px 4px rgba(0, 0, 0, 0.2)` }} className=' rounded p-1 ' name='postMedia' id='postMedia' />
                            </div>
